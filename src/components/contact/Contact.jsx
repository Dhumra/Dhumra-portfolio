...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_9pfgjai', 'template_erhaml7', form.current, 'I7kZY_v2lOssFTI0X')
      .then((result) => {
            ...
            <div className="contact__content">
               ...
               <div className="contact__info">
                  ...
                  <div className="contact__card">
                     ...
                     <span className="contact__card-data">dhumravarnaambre36@gmail.com</span>
                  ...
                  <div className="contact__card">
                     ...
                     <span className="contact__card-data">9137810460</span>
